...
words = ["bitcoin", "insecure", "crypto", "inflation", "ETH","billionaire","money", "India", "secure", "price","legal","tender","future","official", "death"]
search_tweets_by_tags(words,"BTC")
...
if __name__ == "__main__":
    ...
    memory, exec_time = main(data_path=r"data/db-BTC.txt",
                             min_supp=20,
                             show_supp=True,
                             show_one_elem_fi=True,
                             save_fis=True,
                             out_name="output-btc1",
                             spmf_file=True,
                             spmf_name="spmf-transactions-btc")
